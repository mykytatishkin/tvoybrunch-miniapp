...
const products = [  
    ...
    {id: '7',  title: 'Бокс Веганский',                         image: '', size:'',     price: 91, type:'box',        description: ''},
    {id: '8',  title: 'Бокс десертный',                         image: '', size:'',     price: 77, type:'box',        description: ''},
    {id: '9',  title: 'Бокс Круассанами',                       image: '', size:'',     price: 81, type:'box',        description: ''},
    {id: '10', title: 'Бокс Завтрак Европейский',               image: '', size:'',     price: 81, type:'box',        description: ''},
    {id: '11', title: 'Бокс Завтрак Семейный ',                 image: '', size:'',     price: 81, type:'box',        description: ''},

    {id: '12', title: 'Бокс к белому вину',                     image: '', size:'M',    price: 87,  type:'size_box',  description: '895 грамм'},
    {id: '13', title: 'Бокс к белому вину',                     image: '', size:'L',    price: 97,  type:'size_box',  description: '1295 грамм'},
    {id: '14', title: 'Бокс к белому вину',                     image: '', size:'XL',   price: 127, type:'size_box',  description: '1700 грамм'},

    {id: '15', title: 'Бокс с красному вину',                   image: '', size:'M',    price: 87,  type:'size_box',  description: '930 грамм'},
    {id: '16', title: 'Бокс с красному вину',                   image: '', size:'L',    price: 97,  type:'size_box',  description: '1190 грамм'},
    {id: '17', title: 'Бокс с красному вину',                   image: '', size:'XL',   price: 127, type:'size_box',  description: '1420 грамм'},

    {id: '18', title: 'Бокс маленькая италия',                  image: '', size:'',      price: 57, type:'box',       description: ''},

    {id: '19', title: 'Бокс Премиум',                           image: '', size:'M',    price: 101, type:'size_box',  description: '970 грамм'},
    {id: '20', title: 'Бокс Премиум',                           image: '', size:'L',    price: 121, type:'size_box',  description: '1240 грамм'},
    {id: '21', title: 'Бокс Премиум',                           image: '', size:'XL',   price: 151, type:'size_box',  description: '1515 грамм'},

    {id: '22', title: 'Бокс Для Любимой Мамы',                  image: '', size:'',     price: 110, type:'box',       description: ''},

    {id: '23', title: 'Бокс Мясной',                            image: '', size:'M',    price: 101,  type:'size_box', description: '805 грамм'},
    {id: '24', title: 'Бокс Мясной',                            image: '', size:'L',    price: 111,  type:'size_box', description: '1025 грамм'},
    {id: '25', title: 'Бокс Мясной',                            image: '', size:'XL',   price: 141,  type:'size_box', description: '1405 грамм'},

    {id: '26', title: 'Бокс с бургерами',                       image: '', size:'M',    price: 91,   type:'size_box', description: '4 штук - 690 грамм'},
    {id: '27', title: 'Бокс с бургерами',                       image: '', size:'L',    price: 101,  type:'size_box', description: '9 штук - 1210 грамм'},
    {id: '28', title: 'Бокс с бургерами',                       image: '', size:'XL',   price: 131,  type:'size_box', description: '1610 грамм'},

    {id: '29', title: 'Бокс романтический',                     image: '', size:'',     price: 57, type:'box',        description: ''},

    {id: '30', title: 'Бокс с сандвичами',                      image: '', size:'M',    price: 81,   type:'size_box', description: '12 штук - 875 грамм'},
    {id: '31', title: 'Бокс с сандвичами',                      image: '', size:'L',    price: 91,  type:'size_box',  description: '16 штук - 1105 грамм'},

    {id: '33', title: 'Бокс с тарталетками',                    image: '', size:'M',    price: 91,   type:'size_box', description: '20 штук - 680 грамм'},
    {id: '34', title: 'Бокс с тарталетками',                    image: '', size:'L',    price: 101,  type:'size_box', description: '25 штук - 1160 грамм'},
    {id: '35', title: 'Бокс с тарталетками',                    image: '', size:'XL',   price: 131,  type:'size_box', description: '30 штук - 1460 грамм'},

    {id: '35', title: 'Бокс с брускеттами',                     image: '', size:'M',    price: 81,   type:'size_box', description: '12 штук - 720 грамм'},
    {id: '36', title: 'Бокс с брускеттами',                     image: '', size:'L',    price: 91,   type:'size_box', description: '16 штук - 890 грамм'},
    {id: '37', title: 'Бокс с брускеттами',                     image: '', size:'XL',   price: 121,  type:'size_box', description: '24 штук - 1250 грамм'},

    {id: '38', title: 'Бокс фруктовый',                         image: '', size:'',     price: 81,   type:'box',      description: ''},
    {id: '39', title: 'Бокс Тапас микс',                        image: '', size:'',     price: 101,  type:'box',      description: ''},

    {id: '40', title: 'Бокс Сырный',                            image: '', size:'M',    price: 91,   type:'size_box', description: '1010 грамм'},
    {id: '41', title: 'Бокс Сырный',                            image: '', size:'L',    price: 101,  type:'size_box', description: '1150 грамм'},
    {id: '42', title: 'Бокс Сырный',                            image: '', size:'XL',   price: 131,  type:'size_box', description: '1550 грамм'},
